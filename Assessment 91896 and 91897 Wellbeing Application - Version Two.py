...
def memory_exercise_open():
    ...
    memory_button1 = tk.Button(memory_buttonframe, text = ' ', font = ("Arial", 12), height = 9, width = 18, command = lambda: match_click(memory_button1, 0))
    memory_button2 = tk.Button(memory_buttonframe, text = ' ', font = ("Arial", 12), height = 9, width = 18, command = lambda: match_click(memory_button2, 1))
    memory_button3 = tk.Button(memory_buttonframe, text = ' ', font = ("Arial", 12), height = 9, width = 18, command = lambda: match_click(memory_button3, 2))
    memory_button4 = tk.Button(memory_buttonframe, text = ' ', font = ("Arial", 12), height = 9, width = 18, command = lambda: match_click(memory_button4, 3))

    memory_button5 = tk.Button(memory_buttonframe, text = ' ', font = ("Arial", 12), height = 9, width = 18, command = lambda: match_click(memory_button5, 4))
    memory_button6 = tk.Button(memory_buttonframe, text = ' ', font = ("Arial", 12), height = 9, width = 18, command = lambda: match_click(memory_button6, 5))
    memory_button7 = tk.Button(memory_buttonframe, text = ' ', font = ("Arial", 12), height = 9, width = 18, command = lambda: match_click(memory_button7, 6))
    memory_button8 = tk.Button(memory_buttonframe, text = ' ', font = ("Arial", 12), height = 9, width = 18, command = lambda: match_click(memory_button8, 7))

    memory_button9 = tk.Button(memory_buttonframe, text = ' ', font = ("Arial", 12), height = 9, width = 18, command = lambda: match_click(memory_button9, 8))
    memory_button10 = tk.Button(memory_buttonframe, text = ' ', font = ("Arial", 12), height = 9, width = 18, command = lambda: match_click(memory_button10, 9))
    memory_button11 = tk.Button(memory_buttonframe, text = ' ', font = ("Arial", 12), height = 9, width = 18, command = lambda: match_click(memory_button11, 10))
    memory_button12 = tk.Button(memory_buttonframe, text = ' ', font = ("Arial", 12), height = 9, width = 18, command = lambda: match_click(memory_button12, 11))

    memory_button13 = tk.Button(memory_buttonframe, text = ' ', font = ("Arial", 12), height = 9, width = 18, command = lambda: match_click(memory_button13, 12))
    memory_button14 = tk.Button(memory_buttonframe, text = ' ', font = ("Arial", 12), height = 9, width = 18, command = lambda: match_click(memory_button14, 13))
    memory_button15 = tk.Button(memory_buttonframe, text = ' ', font = ("Arial", 12), height = 9, width = 18, command = lambda: match_click(memory_button15, 14))
    memory_button16 = tk.Button(memory_buttonframe, text = ' ', font = ("Arial", 12), height = 9, width = 18, command = lambda: match_click(memory_button16, 15))
